...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY ="com.example.contentprovidertest";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.contentprovidertest.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.contentprovidertest.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.contentprovidertest.category";
            case CATEGORY_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.contentprovidertest.category";
        }
        return null;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)){
            case BOOK_DIR:
                ...
                break;
            case BOOK_ITEM:
                //getPathSegments以"/"分割，将结果放到一个字符串列表中
                //第0个位置存放路径 第1个位置存放id
                String bookId = uri.getPathSegments().get(1);
